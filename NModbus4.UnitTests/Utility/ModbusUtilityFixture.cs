...
namespace Modbus.UnitTests.Utility
{
    public class ModbusUtilityFixture
    {
        ...
        {
            Assert.Equal(new short[] {1, 2}, ModbusUtility.NetworkBytesToHostUInt16(new byte[] { 0, 1, 0, 2 }));
        }
        ...
        {
            Assert.Equal(new short[] {}, ModbusUtility.NetworkBytesToHostUInt16(new byte[] {}));
        }
        ...
        {
            Assert.Equal((int)0, ModbusUtility.GetInt32(0, 0));
            Assert.Equal((int)1, ModbusUtility.GetInt32(0, 1));
            Assert.Equal((int)45, ModbusUtility.GetInt32(0, 45));
            Assert.Equal((int)65536, ModbusUtility.GetInt32(1, 0));
        }
    }
}
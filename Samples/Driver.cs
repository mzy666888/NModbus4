    ...
    public class Driver
    {
        ...
        public static void ModbusSerialRtuMasterWriteRegisters()
        {
            using (SerialPort port = new SerialPort("COM1"))
            {
                ...
                short[] registers = new short[] { 1, 2, 3 };
        ...
        public static void ModbusSerialAsciiMasterReadRegisters()
        {
            using (SerialPort port = new SerialPort("COM1"))
            {
                ...
                // read five registers		
                short[] registers = master.ReadHoldingRegisters(slaveId, startAddress, numRegisters);
        ...
        public static void ModbusTcpMasterReadInputsFromModbusSlave()
        {
            ...
            short[] inputs = master.ReadInputRegisters(startAddress, numInputs);
        ...
        public static void ReadWrite32BitValue()
        {
            using (SerialPort port = new SerialPort("COM1"))
            {
                ...
                short lowOrderValue = BitConverter.ToInt16(BitConverter.GetBytes(largeValue), 0);
                short highOrderValue = BitConverter.ToInt16(BitConverter.GetBytes(largeValue), 2);

                // write large value in two 16 bit chunks
                master.WriteMultipleRegisters(slaveId, startAddress, new short[] { lowOrderValue, highOrderValue });

                // read large value in two 16 bit chunks and perform conversion
                short[] registers = master.ReadHoldingRegisters(slaveId, startAddress, 2);
